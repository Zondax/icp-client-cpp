 ...
 */
void request_id_new_wrap(const uint8_t *bytes, int bytes_len, RetPtr_u8 request_id);

/**
 * Construct a Principal of the IC management canister
 */
void principal_management_canister_wrap(RetPtr_u8 principal);

/**
 * Construct a self-authenticating ID from public key
 */
void principal_self_authenticating_wrap(const uint8_t *public_key,
                                        int public_key_len,
                                        RetPtr_u8 principal);
 ...
 */
void principal_anonymous_wrap(RetPtr_u8 principal);

/**
 * Construct a Principal from a slice of bytes.
 */
void principal_from_slice_wrap(const uint8_t *bytes, int bytes_len, RetPtr_u8 principal);

/**
 * Construct a Principal from a slice of bytes.
 */
ResultCode principal_try_from_slice_wrap(const uint8_t *bytes,
                                         int bytes_len,
 ...
 */
ResultCode principal_from_text_wrap(const char *text, RetPtr_u8 principal_ret, RetPtr_u8 error_ret);

/**
 * Return the textual representation of Principal.
 */
ResultCode principal_to_text_wrap(const uint8_t *bytes,
                                  int bytes_len,
                                  RetPtr_u8 principal_ret,
                                  RetPtr_u8 error_ret);
 ...
 */
void identity_anonymous_wrap(const void **identity_ret);

/**
 * Create a BasicIdentity from reading a PEM Content
 */
ResultCode identity_basic_from_pem_wrap(const char *pem_data,
 ...
 */
ResultCode identity_basic_from_key_pair_wrap(const uint8_t *public_key,
 ...
 */
ResultCode identity_secp256k1_from_pem_wrap(const char *pem_data,
                                            const void **identity_ret,
                                            RetPtr_u8 error_ret);
 ...
 */
void identity_secp256k1_from_private_key_wrap(const char *private_key,
                                              uintptr_t pk_len,
                                              const void **identity_ret);
 ...
 */
ResultCode identity_sender_wrap(const void **id_ptr,
 ...
 */
ResultCode identity_sign_wrap(const uint8_t *bytes,
                              int bytes_len,
                              const void **id_ptr,
                              enum IdentityType idType,
...
void idl_args_to_text_wrap(const void *idl_args, RetPtr_u8 ret_cb);
